...
/home/ubuntu/Scripts/BashDiscord/discord.sh --webhook=$webhook --username "Odin" --text $message1
...
sleep 5m
/home/ubuntu/Scripts/BashDiscord/discord.sh --webhook=$webhook --username "Odin" --text $message2
